...
export default function Products() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get<{ data: Product[] }>('https://nextstore-be.onrender.com/api/v1/televisions/showProduct');
                // const response = await axios.get<{ data: Product[] }>('http://localhost:8000/api/v1/televisions/showProduct');
                console.log({
